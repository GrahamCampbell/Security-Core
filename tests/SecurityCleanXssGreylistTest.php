 ...
 * @internal
 */
final class SecurityCleanXssGreylistTest extends TestCase
{
    public function snippetProvider()
    {
        return [
            ...
            [
                ...
                '&lt;meta charset="x-imap4-modified-utf7"&gt;&alert&A7&(1)&R&UA;&&<&a9&11></&a9&11>',
            ],
            [
    ...
    public function testCleanString(string $input, string $output)
    {
        ...
        $return = $security->xss_clean_greylist($input);
    ...
    public function testCleanArray()
    {
        ...
        $return = $security->xss_clean_greylist(['test', '123', ['abc']]);
